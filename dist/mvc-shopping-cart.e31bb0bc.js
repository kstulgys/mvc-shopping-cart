...
function () {
  ...
  (0, _createClass2.default)(Store, [{
    ...
    value: function addToCart(id) {
      var item = this.allProducts.find(function (el) {
        return el.id === id;
      });
    ...
    value: function () {
      var _getStoreProducts = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                products = (0, _products.default)().map(function (item) {
                ...
                this.pubSub.emit('storeProductsReady', this.allProducts); // const data = await fetch('https://randomuser.me/api/').then(res =>
                //   res.json()
                // )
                // console.log(data)
      ...
      function getStoreProducts() {
        return _getStoreProducts.apply(this, arguments);
      }
    ...
    value: function () {
      var _getCartItemsFromStorage = (0, _asyncToGenerator2.default)(
      /*#__PURE__*/
      ...
      function getCartItemsFromStorage() {
        return _getCartItemsFromStorage.apply(this, arguments);
      }
...
/*#__PURE__*/
function () {
  function StoreView(wrapper, pubSub) {
    (0, _classCallCheck2.default)(this, StoreView);
...
function () {
  function StoreController(store) {
    (0, _classCallCheck2.default)(this, StoreController);
    this.store = store;
    this.init();
  }

  (0, _createClass2.default)(StoreController, [{
    key: "init",
    value: function init() {// console.log(this.store.allItems) // logs empty array
    }
  }]);
...
//# sourceMappingURL=/mvc-shopping-cart.e31bb0bc.js.map